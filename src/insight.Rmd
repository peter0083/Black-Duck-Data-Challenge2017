...
### Most popular projects by license ID

```{rMost popular projects by uuid, version and license ID}
top_projects <- data %>% 
...
### Most popular projects by uuid and version only
...
### Most common license ID used in this collection of open source projects
...
### Most popular project by uuid only
